...
export const GET_REVIEWS_OF_BLOG_REQUEST = "BLOG.GET_REVIEWS_OF_BLOG_REQUEST";
export const GET_REVIEWS_OF_BLOG_SUCCESS = "BLOG.GET_REVIEWS_OF_BLOG_SUCCESS";
export const GET_REVIEWS_OF_BLOG_FAILURE = "BLOG.GET_REVIEWS_OF_BLOG_FAILURE";

export const GET_BLOGS_OF_USER_REQUEST = "EVENT.GET_BLOGS_OF_USER_REQUEST";
export const GET_BLOGS_OF_USER_SUCCESS = "EVENT.GET_BLOGS_OF_USER_SUCCESS";
export const GET_BLOGS_OF_USER_FAILURE = "EVENT.GET_BLOGS_OF_USER_FAILURE";
